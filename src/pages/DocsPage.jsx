      ...
      <div className="marketing-container" style={{ maxWidth: "900px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          <h1 style={{ fontSize: "42px", fontWeight: 900, color: "#fff", marginBottom: "20px" }}>
            Getting Started with <span className="hero-gradient-text">Tilde</span>
          </h1>
          <p style={{ fontSize: "18px", color: "var(--text-muted)", lineHeight: "1.6" }}>
            Learn how to handle interactive standard input, customize compiler flags, and install Tilde on your phone or laptop.
          </p>
        </div>
        ...
        <div className="glass-card" style={{ padding: "40px", marginBottom: "40px" }}>
          ...
          <p style={{ fontSize: "15px", color: "var(--text-muted)", lineHeight: "1.7", marginBottom: "20px" }}>
            You can install Tilde as a standalone desktop or mobile application. When installed, clicking the app icon will bypass marketing pages and open <strong>directly into the coding workspace</strong>!
          </p>

          <div style={{ display: "flex", flexDirection: "column", gap: "16px", fontSize: "14px", color: "var(--text-main)" }}>
            <div style={{ padding: "16px", background: "rgba(56, 189, 248, 0.1)", borderLeft: "4px solid var(--tilde-cyan)", borderRadius: "0 8px 8px 0" }}>
              <strong style={{ color: "#fff" }}>💻 Laptop / Desktop (Chrome, Edge, Brave):</strong> Look for the install icon (➕ or 💻) in the top right of your browser's URL address bar, or click "📥 Install App" in our navigation bar!
            </div>
            <div style={{ padding: "16px", background: "rgba(129, 140, 248, 0.1)", borderLeft: "4px solid #818cf8", borderRadius: "0 8px 8px 0" }}>
            ...
            <div style={{ padding: "16px", background: "rgba(192, 132, 252, 0.1)", borderLeft: "4px solid #c084fc", borderRadius: "0 8px 8px 0" }}>
